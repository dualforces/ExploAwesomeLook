...
(function($){
	...
	function megaMenuOver(){
		...
		if(hoverIntentEffect === 'hover_fade'){
			...
			// alert($(this).next("span a"));
			$(this).css("border-top", "4px solid #000");
	
			
			
			// alert($(this).('span:first-child').html());
			//$(this).children('.drop').find("a").toggleClass("megamenu_hoverswap");
			$(this).addClass("megamenu_hoverswap");
				$(this).hover(function() {
	...
	function megaMenuOut(){
		...
		//$(this).children('.drop').find("a").toggleClass("megamenu_hoverswap");
		$(this).removeClass("megamenu_hoverswap");
	}
